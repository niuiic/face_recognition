...
Result ResourceLoad::InitModel(const char *omModelPath1,
                               const char *omModelPath2,
...
DvppProcess &ResourceLoad::GetDvpp() { return dvpp_; }
...
Result ResourceLoad::SendNextModelProcess(
    const string objStr, std::shared_ptr<FaceRecognitionInfo> &image_handle) {
