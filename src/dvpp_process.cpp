...
DvppProcess::~DvppProcess() { DestroyResource(); }
...
Result DvppProcess::Resize(ImageData1 &dest, ImageData1 &src, uint32_t width,
                           uint32_t height) {
...
Result DvppProcess::cropimage(ImageData1 &dest, ImageData1 &src,
  ...
  DvppCropAndPaste crop(stream_, dvppChannelDesc_, lt_horz, lt_vert, rb_horz,
                        rb_vert);
