...
ModelProcess::ModelProcess()
    : loadFlag_(false), modelId_(0), modelMemPtr_(nullptr), modelMemSize_(0),
...
aclmdlDataset *ModelProcess::GetModelOutputData() { return output_; }
