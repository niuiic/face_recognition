...
Result DvppResize::InitResizeInputDesc(ImageData1& inputImage)
{
    ...
    //INFO_LOG("DvppResize input image width %d, height %d, al w %d h %d\n", inputImage.width, inputImage.height, alignWidth, alignHeight);
    //INFO_LOG("DvppResize input inputImage.data %llx size %d, inputBufferSize %d\n", inputImage.data.get(), inputImage.size, inputBufferSize);
