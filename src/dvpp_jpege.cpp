...
DvppJpegE::DvppJpegE(aclrtStream &stream, acldvppChannelDesc *dvppChannelDesc)
    : stream_(stream), dvppChannelDesc_(dvppChannelDesc), jpegeConfig_(nullptr),
      encodeOutBufferSize_(0), encodeOutBufferDev_(nullptr),
...
Result DvppJpegE::InitJpegEResource(ImageData1 &inputImage) {
  ...
  aclError aclRet = acldvppJpegPredictEncSize(encodeInputDesc_, jpegeConfig_,
...
#define SHARED_PRT_JPEGE_DVPP_BUF(buf)                                         \
