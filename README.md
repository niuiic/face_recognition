...
本项目根据官方例程修改，支持从摄像头和本地视频识别已注册的人脸。
...
Atlas 200 DK 开发套件为开发者提供了一套适配硬件加速的接口，用户可以按照[文档](https://support.huaweicloud.com/asdevg-c-A200dk_3000_c75/atlasdevelopment_01_0007.html)说明，和参考[例程](https://gitee.com/ascend/samples)进行调用。
